...
![alt text](https://github.com/THEKINGSTAR/alx-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/code.png?raw=true)
...
## **` 2. I sometimes suffer from insomnia. And when I can't fall asleep, I play what I call thealphabet game (mandatory)`**
