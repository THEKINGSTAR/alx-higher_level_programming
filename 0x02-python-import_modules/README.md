...
- The output should be:
    ...
    - or 
    - arguments (otherwise), followed by ```:``` (or ```.``` if no arguments were passed) followed by a new line, followed by (if at least one argument),
...
* Last but not least, your program should also handle big numbers. And the good news is:
    * if your program works for the above example, it will work for the following example:
...
### Write a program that imports all functions from the file ```calculator_1.py``` and should handles basic operations.
